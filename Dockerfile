...
RUN apt-get update -qqy \
  ...
  && echo "echo \"tools\" && sdkmanager \"tools\" > /dev/null" > install.sh \
  && echo "echo \"platform-tools\" && sdkmanager \"platform-tools\" > /dev/null" > install.sh \
  && echo "echo \"extras;android;m2repository\" && sdkmanager \"extras;android;m2repository\" > /dev/null" > install.sh \
  && echo "echo \"extras;google;m2repository\" && sdkmanager \"extras;google;m2repository\" > /dev/null" > install.sh \
