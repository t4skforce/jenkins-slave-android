...
ENV KOTLIN_VERSION "v1.3.20"
ENV KOTLIN_DOWNLOADURL "https://github.com/JetBrains/kotlin/releases/download/v1.3.20/experimental-kotlin-compiler-linux-x64.zip"
