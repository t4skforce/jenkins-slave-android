...
ENV KOTLIN_VERSION "v1.3.40"
ENV KOTLIN_DOWNLOADURL "https://github.com/JetBrains/kotlin/releases/download/v1.3.40/kotlin-compiler-1.3.40.zip"
ENV ANDROID_SDK_VERSION "4333796"
ENV ANDROID_SDK_DOWNLOADURL "/dynamic_shared/https://dl.google.com/android/repository/sdk-tools-linux-4333796.zip"
