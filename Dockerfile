...
ENV KOTLIN_VERSION "v1.3.31"
ENV KOTLIN_DOWNLOADURL "https://github.com/JetBrains/kotlin/releases/download/v1.3.31/experimental-kotlin-compiler-linux-x64.zip"
