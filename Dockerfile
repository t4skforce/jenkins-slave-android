...
ENV KOTLIN_VERSION "v1.3.11"
ENV KOTLIN_DOWNLOADURL "https://github.com/JetBrains/kotlin/releases/download/v1.3.11/experimental-kotlin-compiler-linux-x64.zip"
