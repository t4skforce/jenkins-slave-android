...
ENV KOTLIN_VERSION "v1.3.0"
ENV KOTLIN_DOWNLOADURL "https://github.com/JetBrains/kotlin/releases/download/v1.3.0/kotlin-compiler-1.3.0-release-linux-x64.zip"
